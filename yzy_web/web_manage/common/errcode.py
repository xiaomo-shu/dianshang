...
ERROR_CODE = {
    ...
    "VoiTerminalUpgradeNameError": {"code": 10061, "msg": "VOI终端上传文件名格式不正确"},
    "HAInfoNotExist": {"code": 10062, "msg": "HA不存在"},
    "VIPAndMasterIpError": {"code": 10063, "msg": "浮动IP与主控管理IP不在同一网段"},
    "HaNicFlatVSUplinkError": {"code": 10064, "msg": "网卡已绑定Flat类型分布式虚拟交换机，启用HA失败"},
    "NodesNotReadyError": {"code": 10065, "msg": "主控和备控必须都在线且HA运行状态正常，才能操作"},
    "NotHAInfoIPError": {"code": 10066, "msg": "参数错误，IP不是主备控IP"},
    "DeleteHaNodeError": {"code": 10067, "msg": "删除节点中包含HA备控，请先禁用HA"},
    "FlatVSUplinkNicHaError": {"code": 10068, "msg": "已启用HA的网卡不能绑定Flat类型的分布式虚拟交换机"},
    "NodesNotAllActiveError": {"code": 10069, "msg": "主控和控必须都在线，才能启用HA"},
    "HaNicAddIPError": {"code": 10070, "msg": "已启用HA的网卡不能添加附属IP"},
    "HaNicEditIPError": {"code": 10071, "msg": "已启用HA的网卡不能编辑IP或网关"},
    "HaNicDeleteIPError": {"code": 10072, "msg": "已启用HA的网卡不能删除IP"},
    "HaNicBondError": {"code": 10073, "msg": "已启用HA的网卡不能作为Bond绑定网卡"},
    "HaBondEditDeleteError": {"code": 10074, "msg": "已启用HA的Bond不能编辑或删除"},
    "SensitivityLessThan60Error": {"code": 10075, "msg": "敏感度不能低于60秒"},
    "IPNotExist": {"code": 10076, "msg": "IP地址'{ip}'不存在"},
    "TemplateUnderTheAccountError": {"code": 10077, "msg": "该账号下存在模板，不可删除"},
    "LogFileDoesNotExistError": {"code": 10078, "msg": "该系统日志不存在，导出失败"},
    "HaNodePasswordError": {"code": 10079, "msg": "备控节点安全性验证不通过，请重新输入验证密码"},
    "TerminalOfflineError":{"code": 10080, "msg": "终端离线"},
    ...
    "TerminalNotSortError": {"code": 10223, "msg": "存在未进行排序终端"},
    ...
    "StorageRoleMissing": {"code": 20231, "msg": "存储角色不完整"},
    "InvalidNfsServerError": {"code": 20232, "msg": "无效的NFS服务器"},
    "RemoteStorageAddFail": {"code": 20233, "msg": "远端存储添加失败: {reason}"},
    "RemoteStorageDeleteFail": {"code": 20234, "msg": "远端存储删除失败: {reason}"},
    "RemoteStorageAllocateError": {"code": 20235, "msg": "远端存储分配失败: {reason}"},
    "RemoteStorageReclaimError": {"code": 20236, "msg": "远端存储回收失败: {reason}"},
    ...
    "DhcpIpAddressConflictError": {"code": 20323, "msg": "所填DHCP IP地址段与已有DHCP IP地址段存在交集"},
