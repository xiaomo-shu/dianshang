...
msg = b'\x01\x00\x01\x00)#\x00\x00\x01\x00\x00\x00+\x00\x00\x00\x01\x00\x01\x01\x00\x00\x00\x00{"mac": "11111-11112", "ip": "172.16.1.58"}'
msg2 = b'\x01\x00\x00\x00\x02\x00\x00\x00!\x1d\x00\x00=\x00\x00\x00\x01\x00\x01\x01\x08\x00\x00\x0012345678{"cmd": "template_disk_list", "data": {"mac": "11111-11112"}}'
msg3 = b'\x01\x00\x00\x00\x03\x00\x00\x00c\x13\x00\x00\x0e\x01\x00\x00\x01\x00\x01\x01\x08\x00\x00\x0012345678{"cmd": "compare_template", "data": {"mac": "11111-11112", "template": {"system_disks": ["voi_0_91f9d1ba-cb4a-41ba-971a-618f9e306571", "voi_1_91f9d1ba-cb4a-41ba-971a-618f9e306571"], "template_name": "voi_test1", "template_uuid": "f15a1759-789e-4e17-a3e1-e723121e9314"}}}'
heart_msg = b'\x01\x00\x01\x00(#\x00\x00\x01\x00\x00\x00\x16\x00\x00\x00\x01\x00\x01\x01 \x00\x00\x00%s{"mac": "11111-11112"}'
...
def main():
    msg = b'\x01\x00\x01\x00)#\x00\x00\x01\x00\x00\x00+\x00\x00\x00\x01\x00\x01\x01\x00\x00\x00\x00{"mac": "11111-11112", "ip": "172.16.1.56"}'
    ...
    while True:
        ...
        if service_code == 9000:
            ...
            with open("torrent_test_2.torrent", "wb") as f:
